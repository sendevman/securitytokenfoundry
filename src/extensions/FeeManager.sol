...
abstract contract FeeManager {
  ...
  function _getFeeAmount(uint8 marketType, uint256 amount) internal view returns (uint256 buyerFee, uint256 sellerFee) {
  ...
  function getFeeToken() internal view returns (IERC20) {
    return feeToken;
  }
